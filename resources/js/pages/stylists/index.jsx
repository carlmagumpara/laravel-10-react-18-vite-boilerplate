...
import { Create, Edit, Delete, ChangeColor } from './Actions';
                  ...
                  <tbody>
                    {data.data.map(item => (
                      <tr key={item.id}>
                        ...
                        <td>{item.stylist_position.name}</td>
                        <td>
                          <ChangeColor item={item} antMessage={antMessage} />
                        </td>
                        <td width="100">
